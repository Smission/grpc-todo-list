...
func (c *todoServiceClient) AddTask(ctx context.Context, in *AddTaskRequest, opts ...grpc.CallOption) (*TaskResponse, error) {
...
func (c *todoServiceClient) CompleteTask(ctx context.Context, in *CompleteTaskRequest, opts ...grpc.CallOption) (*TaskResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TaskResponse)
...
func (UnimplementedTodoServiceServer) AddTask(context.Context, *AddTaskRequest) (*TaskResponse, error) {
...
func (UnimplementedTodoServiceServer) CompleteTask(context.Context, *CompleteTaskRequest) (*TaskResponse, error) {
